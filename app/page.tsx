    ...
    <div className="bg-skyblue/10">
        ...
        <div className="flex justify-between">
          <div>
            <div className="flex gap-2 items-center mt-10">
              ...
              <p className="font-sora text-navy text-[14px] fomt-bold">Recruitment & HR Specialist - Africa</p>
            </div>
            <div className="font-sora font-bold text-navy leading-15 my-4">
              <p className="text-[3.3rem]">Beyond Talent.</p>
              <p className="text-[3.3rem]">Beyond Expectation.</p>
            </div>
            <div>
              <p className="w-140 font-inter text-navy/70 mb-6">Mastery Workforce PEO Limited is a recruitment and HR specialist company helping organisations across the continent find critical talent, access cutting-edge advice, and get the innovative support they need to grow in a challenging market.</p>
              <div className="flex items-center gap-3">
                <div className="py-2.5 px-5 border border-navy/10">
                  <p className="text-navy">Explore our Solutions</p>
                </div>
                <div className="bg-navy py-2.5 px-5 text-white">
                  <p>Get in Touch</p>
                </div>
              </div>
              <div className="flex gap-2 items-center my-8">
                <div className="flex">
                  <div className="h-8 w-8 bg-navy text-white font-sora flex rounded-full items-center border-2 border-white justify-center"><p className="text-[11px] font-semibold">A</p></div>
                  <div className="h-8 w-8 bg-blue-300 text-navy font-sora flex rounded-full items-center border-2 border-white -ml-3 justify-center"><p className="text-[11px] font-semibold">K</p></div>
                  <div className="h-8 w-8 bg-sky-100 text-navy font-sora flex rounded-full items-center border-2 border-white -ml-3 justify-center"><p className="text-[11px] font-semibold">N</p></div>
                  <div className="h-8 w-8 bg-white text-navy font-sora flex rounded-full items-center border-2 border-white -ml-3 justify-center"><p className="text-[11px] font-semibold">+</p></div>
                </div>
                <div>
                  <p className="text-navy text-[13px] font-sora">Trusted by HR leaders across the continent</p>
                </div>
              </div>
            </div>
          </div>
          <div className="relative">
            <div className="bg-skyblue rounded-lg font-sora py-1.5 px-4 w-fit leading-4 float-right -mb-4 relative z-5 -mr-3">
            ...
            <div>
              <Image src={hero2} alt="corporate office pic" className="rounded-2xl z-1 shadow-md" />
            </div>
            <div className="bg-white grid grid-cols-2 rounded-2xl w-80 h-30 -mt-20 z-10 -ml-10 relative">
              <div>
                <Image src={hero3} alt="corporate office pic" className="rounded-l-2xl w-full h-full object-cover" />
              </div>
              <div className="p-2">
                <p className="text-navy text-[15px]">One partner, Every people needs</p>
                <p className="text-navy/70 text-[11px]">Search, outsourcing, advisory & training - Integrated</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto pb-18">
        <div className="grid grid-cols-2 mt-30">
          <div className="px-8">
            <Image src={intro} alt="corporate office pic" className="rounded-2xl z-1 shadow-md w-full h-120 object-cover" />
          </div>
          <div className="px-6">
            ...
            <p className="font-sora text-navy text-[2.5rem] leading-12">We go beyond - or clients, candidates, and community.</p>
            <p className="text-navy/70 font-inter text-[1.1rem] my-4">We go beyond narrowly defined client issues, beyond conventional wisdom, beyond the expected, to create opportunities for our clients, candidates, colleagues, collaborators, and community.</p>
            <p className="text-navy/70 font-inter text-[1.1rem] my-4">Through a network of diversified but highly complementary lines of business, we've helped some of the most important and exciting organisations on the continent find the critical talent, access cutting-edge advice, and get the innovative support they require to grow in a challenging market.</p>
          </div>
        </div>
      </div>
      {/**Solutions Section */}
      <div className="bg-skyblue/20 border-y border-navy/10">
        <div className="max-w-6xl mx-auto py-18">
          <div className="flex justify-between">
            <div>
              <p className="font-sora text-navy/70 text-[12px] tracking-wider">WHAT WE DO</p>
              <p className="font-sora text-[1.6rem] text-navy ">Solutions built for African Businesses</p>
            </div>
            <div>
              <p className="text-navy/70 w-80">Tailored HR and workforce solutions built around what your business actually needs.</p>
            </div>
          </div>
          <div className="grid grid-cols-4 gap-10 my-8">
            <div className="border border-navy/20 py-6 w-fit px-6 rounded-md bg-white shadow-sm">
      ...
      <div>
        <div className="max-w-7xl mx-auto py-18">
          <div className="grid grid-cols-2 gap-12">
            <div>
              <p className="font-sora text-navy/70 text-[12px] tracking-wider">WHY MASTERY WORKFORCE</p>
              <p className="font-sora text-navy text-[1.8rem] my-3">
                A Partner you can{" "}
                <span className="relative inline-block">
                  ...
                  >
                    <path
                      d="M2 7 C20 3, 35 5, 50 6 C68 7, 82 10, 98 5"
                      stroke="currentColor"
                      strokeWidth="4"
                      strokeLinecap="round"
                      fill="none"
                    ...
                    <path
                      d="M2 8 C25 6, 45 7, 65 8 C80 9, 90 8, 98 5"
                      stroke="currentColor"
                      strokeWidth="1"
                      strokeLinecap="round"
                      fill="none"
              ...
              <p className="text-navy/70 text-[1.1rem] font-inter w-130">Choosing a workforce partner is a decision of confidence. Here's why organisations acroos the continent choose Mastery Workforce - and stay with us.</p>
              <div className="bg-navy text-white p-4 rounded-lg w-140 my-6">
                <p className="text-[1.3rem] my-2">"Mastery Workforce understood exactly what our business needed — not just to fill roles, but to build real capability. They've become a true partner to our HR function."</p>
                <div className="flex gap-2 items-center">
                  <div className="bg-white/70 h-[2px] w-5"></div>
                  <p className="font-sora text-white/70 text-[14px] fomt-bold">Group HR Director, Pan-African Financial Services</p>
                </div>
              </div>
            </div>
            <div>
              <div className="flex gap-4 items-center border-b border-navy/20 pb-4">
                <div className="p-2 rounded-full text-navy bg-skyblue/30 w-fit">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                <div>
                  <p className="text-navy font-sora text-[1.1rem]">Local Market Expertise</p>
              ...
              <div className="flex gap-4 items-center border-b border-navy/20 py-4">
                ...
                <div>
                  <p className="text-navy font-sora text-[1.1rem]">Diversified business lines</p>
              ...
              <div className="flex gap-4 items-center border-b border-navy/20 py-4">
                ...
                <div>
                  <p className="text-navy font-sora text-[1.1rem]">Proven track record</p>
              ...
              <div className="flex gap-4 items-center border-b border-navy/20 py-4">
                ...
                <div>
                  <p className="text-navy font-sora text-[1.1rem]">Custom solutions</p>
              ...
              <div className="flex gap-4 items-center border-b border-navy/20 py-4">
                ...
                <div>
                  <p className="text-navy font-sora text-[1.1rem]">Partnet Mindset</p>
        ...
        <div className="max-w-7xl mx-auto py-16">
          <div className="grid grid-cols-2">
            <div>
              ...
              <div className="font-sora font-semibold text-navy leading-10 my-4">
                <p className="text-[2.4rem]">Ready to build a stronger workforce?</p>
                <p className="text-[2.4rem]">Let's talk about what's next.</p>
              </div>
              <div>
                <p className="text-[1.1rem] text-navy/70 font-inter w-120">Tell us where your business is headed - a workforce specialist would respond within one business day with clear next steps.</p>
              </div>
